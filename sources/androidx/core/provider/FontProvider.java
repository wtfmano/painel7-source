...
public class FontProvider {
    ...
    @NonNull
    public static FontsContractCompat.FontFamilyResult getFontFamilyResult(@NonNull Context context, @NonNull FontRequest request, @Nullable CancellationSignal cancellationSignal) throws PackageManager.NameNotFoundException {
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest request, String authority, CancellationSignal cancellationSignal) {
        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                ArrayList<FontsContractCompat.FontInfo> result2 = new ArrayList<>();
                try {
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        result2.add(FontsContractCompat.FontInfo.create(fileUri, ttcIndex, weight, italic, resultCode));
                    }
                    result = result2;
                } catch (Throwable th) {
                    th = th;
