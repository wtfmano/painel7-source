...
public class AnimatedStateListDrawableCompat extends StateListDrawable implements TintAwareDrawable {
    ...
    private int parseTransition(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        if (resourceId3 > 0) {
            animatedVectorDrawableCompat = ResourceManagerInternal.get().getDrawable(context, resourceId3);
        }
        ...
        if (animatedVectorDrawableCompat == null) {
            ...
            if (xmlPullParser.getName().equals("animated-vector")) {
                animatedVectorDrawableCompat = AnimatedVectorDrawableCompat.createFromXmlInner(context, resources, xmlPullParser, attributeSet, theme);
            } else if (Build.VERSION.SDK_INT >= 21) {
                animatedVectorDrawableCompat = Drawable.createFromXmlInner(resources, xmlPullParser, attributeSet, theme);
            } else {
                animatedVectorDrawableCompat = Drawable.createFromXmlInner(resources, xmlPullParser, attributeSet);
            }
        }
        if (animatedVectorDrawableCompat == null) {
            throw new XmlPullParserException(xmlPullParser.getPositionDescription() + TRANSITION_MISSING_DRAWABLE_ERROR);
    ...
    private int parseItem(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        if (resourceId2 > 0) {
            vectorDrawableCompat = ResourceManagerInternal.get().getDrawable(context, resourceId2);
        }
        obtainAttributes.recycle();
        ...
        if (vectorDrawableCompat == null) {
            ...
            if (xmlPullParser.getName().equals("vector")) {
                vectorDrawableCompat = VectorDrawableCompat.createFromXmlInner(resources, xmlPullParser, attributeSet, theme);
            } else if (Build.VERSION.SDK_INT >= 21) {
                vectorDrawableCompat = Drawable.createFromXmlInner(resources, xmlPullParser, attributeSet, theme);
            } else {
                vectorDrawableCompat = Drawable.createFromXmlInner(resources, xmlPullParser, attributeSet);
            }
        }
        if (vectorDrawableCompat == null) {
            throw new XmlPullParserException(xmlPullParser.getPositionDescription() + ITEM_MISSING_DRAWABLE_ERROR);
    ...
    public static class AnimatedStateListState extends StateListDrawable.StateListState {
        ...
        int addTransition(int i, int i2, @NonNull Drawable drawable, boolean z) {
            ...
            if (z) {
                this.mTransitions.append(generateTransitionKey(i2, i), Long.valueOf(addChild | REVERSED_BIT | j));
            }
            return addChild;
        }
