...
public final class ResourceManagerInternal {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i, boolean z, @NonNull Drawable drawable) {
        ...
        } else if ((this.mHooks == null || !this.mHooks.tintDrawable(context, i, drawable2)) && !tintDrawableUsingColorFilter(context, i, drawable2) && z) {
            drawable2 = null;
        }
        return drawable2;
    }
    ...
    PorterDuff.Mode getTintMode(int i) {
        return this.mHooks == null ? null : this.mHooks.getTintModeForDrawableRes(i);
    }
    ...
    private ColorStateList getTintListFromCache(@NonNull Context context, @DrawableRes int i) {
        if (this.mTintLists != null) {
            ...
            return sparseArrayCompat != null ? sparseArrayCompat.get(i) : null;
        }
        return null;
    }
