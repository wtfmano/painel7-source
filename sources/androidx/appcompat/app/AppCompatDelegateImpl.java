...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private boolean applyDayNight(boolean allowRecreation) {
        ...
        boolean updateForNightMode = updateForNightMode(modeToApply, allowRecreation);
        if (nightMode == 0) {
    ...
    private boolean updateForNightMode(int mode, boolean allowRecreation) {
        ...
        if (currentNightMode != newNightMode && allowRecreation && !activityHandlingUiMode && this.mBaseContextAttached && ((sCanReturnDifferentContext || this.mCreated) && (this.mHost instanceof Activity) && !((Activity) this.mHost).isChild())) {
