...
public class ConstraintLayout extends ViewGroup {
    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            if (constraintWidget.getVisibility() == 8 && !constraintWidget.isInPlaceholder()) {
                ...
                if (parent != null && Optimizer.enabled(ConstraintLayout.this.mOptimizationLevel, 256) && view.getMeasuredWidth() == constraintWidget.getWidth() && view.getMeasuredWidth() < parent.getWidth() && view.getMeasuredHeight() == constraintWidget.getHeight() && view.getMeasuredHeight() < parent.getHeight() && view.getBaseline() == constraintWidget.getBaselineDistance() && !constraintWidget.isMeasureRequested()) {
    ...
    public void applyConstraintsFromLayoutParams(boolean z, View view, ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray<ConstraintWidget> sparseArray) {
        ...
        if (layoutParams.isInPlaceholder) {
            constraintWidget.setInPlaceholder((boolean) USE_CONSTRAINTS_HELPER);
    ...
    private void setWidgetBaseline(ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray<ConstraintWidget> sparseArray, int i, ConstraintAnchor.Type type) {
        ...
        if (type == ConstraintAnchor.Type.BASELINE) {
            ...
            layoutParams2.widget.setHasBaseline((boolean) USE_CONSTRAINTS_HELPER);
        }
        constraintWidget.getAnchor(ConstraintAnchor.Type.BASELINE).connect(constraintWidget2.getAnchor(type), layoutParams.baselineMargin, layoutParams.goneBaselineMargin, (boolean) USE_CONSTRAINTS_HELPER);
        constraintWidget.setHasBaseline((boolean) USE_CONSTRAINTS_HELPER);
