...
public class MotionController {
            ...
            while (i16 < size) {
                if (motionPathsArr[i16].hasCustomData(str8)) {
                    if (dArr3 == null) {
                        ...
                        iArr3[1] = motionPathsArr[i16].getCustomDataCount(str8);
                        iArr3[c] = size;
    ...
    public boolean interpolate(View view, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            int i4 = (int) f8;
            int i5 = (int) (f7 + this.mStartMotionPath.width + ((this.mEndMotionPath.width - this.mStartMotionPath.width) * f5));
            int i6 = (int) (f8 + this.mStartMotionPath.height + ((this.mEndMotionPath.height - this.mStartMotionPath.height) * f5));
            int i7 = i5 - i3;
            int i8 = i6 - i4;
        ...
        if (hashMap4 != null) {
            for (KeyCycleOscillator keyCycleOscillator : hashMap4.values()) {
                if (keyCycleOscillator instanceof KeyCycleOscillator.PathRotateSet) {
                    ...
                    ((KeyCycleOscillator.PathRotateSet) keyCycleOscillator).setPathRotate(view, f5, dArr4[0], dArr4[c]);
                } else {
