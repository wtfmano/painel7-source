        ...
        private void setupConstraintWidget(ConstraintWidgetContainer constraintWidgetContainer, ConstraintSet constraintSet) {
            ...
            while (it3.hasNext()) {
                ...
                if (virtualLayout instanceof VirtualLayout) {
                    ...
                    ((ConstraintHelper) virtualLayout.getCompanionWidget()).updatePreLayout(constraintWidgetContainer, virtualLayout2, sparseArray);
    ...
    public void evaluate(boolean z) {
        ...
        if (this.mKeepAnimating || (this.mInTransition && (z || this.mTransitionGoalPosition != this.mTransitionLastPosition))) {
            ...
            if (interpolator5 != null) {
                float interpolation4 = interpolator5.getInterpolation((signum / this.mTransitionDuration) + f3);
            ...
            while (i3 < childCount) {
                ...
                if (motionController != null) {
                    i2 = i3;
                    this.mKeepAnimating |= motionController.interpolate(childAt, interpolation3, nanoTime2, this.mKeyCache);
                } else {
                    i2 = i3;
                }
                i3 = i2 + 1;
