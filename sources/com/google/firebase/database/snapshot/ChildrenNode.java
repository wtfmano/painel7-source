...
public class ChildrenNode implements Node {
    ...
    static {
        ...
        NAME_ONLY_COMPARATOR = new Comparator<ChildKey>() { // from class: com.google.firebase.database.snapshot.ChildrenNode.1
    ...
    public Node updatePriority(Node priority) {
        return this.children.isEmpty() ? EmptyNode.Empty() : new ChildrenNode(this.children, priority);
    }
