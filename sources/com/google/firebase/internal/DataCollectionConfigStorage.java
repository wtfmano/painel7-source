...
public class DataCollectionConfigStorage {
    ...
    private static Context directBootSafe(Context applicationContext) {
        return (Build.VERSION.SDK_INT < 24 || ContextCompat.isDeviceProtectedStorage(applicationContext)) ? applicationContext : ContextCompat.createDeviceProtectedStorageContext(applicationContext);
    }
