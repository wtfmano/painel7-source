...
public class CheckableImageButton extends AppCompatImageButton implements Checkable {
    ...
    public int[] onCreateDrawableState(int extraSpace) {
        return this.checked ? mergeDrawableStates(super.onCreateDrawableState(DRAWABLE_STATE_CHECKED.length + extraSpace), DRAWABLE_STATE_CHECKED) : super.onCreateDrawableState(extraSpace);
    }
