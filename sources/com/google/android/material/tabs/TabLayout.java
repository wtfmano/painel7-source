...
public class TabLayout extends HorizontalScrollView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (View.MeasureSpec.getMode(widthMeasureSpec) != 0) {
            this.tabMaxWidth = this.requestedTabMaxWidth > 0 ? this.requestedTabMaxWidth : (int) (specWidth - ViewUtils.dpToPx(getContext(), 56));
        }
    ...
    private int calculateScrollXForTab(int position, float positionOffset) {
        if (this.mode == 0 || this.mode == 2) {
            ...
            int nextWidth2 = ViewCompat.getLayoutDirection(this) == 0 ? scrollBase + scrollOffset : scrollBase - scrollOffset;
            return nextWidth2;
        }
        return 0;
    }
    ...
    public final class TabView extends LinearLayout {
        ...
        public TabView(@NonNull Context context) {
            ...
            setGravity(17);
            setOrientation(this$0.inlineLabel ? 0 : 1);
            setClickable(true);
        ...
        public void updateBackgroundDrawable(Context context) {
            ...
            if (TabLayout.this.tabRippleColorStateList != null) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    background = new RippleDrawable(rippleColor, contentDrawable, TabLayout.this.unboundedRipple ? null : maskDrawable);
                } else {
    ...
    public class SlidingTabIndicator extends LinearLayout {
        ...
        public void tweenIndicatorPosition(View startTitle, View endTitle, float fraction) {
            ...
            if (hasVisibleTitle) {
                TabLayout.this.tabIndicatorInterpolator.setIndicatorBoundsForOffset(TabLayout.this, startTitle, endTitle, fraction, TabLayout.this.tabSelectedIndicator);
            } else {
