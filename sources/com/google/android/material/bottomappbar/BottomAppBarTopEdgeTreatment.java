...
public class BottomAppBarTopEdgeTreatment extends EdgeTreatment implements Cloneable {
    ...
    public void getEdgePath(float length, float center, float interpolation, @NonNull ShapePath shapePath) {
        ...
        if (useCircleCutout) {
            ...
            float cutoutDiameter = this.fabMargin + (2.0f * cornerSize);
            shapePath.addArc(middle - cradleRadius, -(this.fabMargin + cornerSize), (middle - cradleRadius) + cutoutDiameter, this.fabMargin + cornerSize, 180.0f - cutoutArcOffset, ((2.0f * cutoutArcOffset) - 180.0f) / 2.0f);
            shapePath.lineTo((middle + cradleRadius) - ((this.fabMargin / 2.0f) + cornerSize), this.fabMargin + cornerSize);
            shapePath.addArc((middle + cradleRadius) - ((2.0f * cornerSize) + this.fabMargin), -(this.fabMargin + cornerSize), middle + cradleRadius, this.fabMargin + cornerSize, 90.0f, (-90.0f) + cutoutArcOffset);
        }
    ...
    public void setCradleVerticalOffset(@FloatRange(from = 0.0d) float cradleVerticalOffset) {
