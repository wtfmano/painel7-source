...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void drawShadow(@NonNull Canvas canvas) {
        ...
        float shadowOffsetHorizontal = this.rawShadowSize - (this.rawShadowSize * SHADOW_HORIZ_SCALE);
    ...
    public float getMinHeight() {
        float content = 2.0f * Math.max(this.rawMaxShadowSize, this.cornerRadius + ((this.rawMaxShadowSize * SHADOW_MULTIPLIER) / 2.0f));
