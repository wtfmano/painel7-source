    ...
    public MaterialAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int defStyleAttr) {
        ...
        this.modalListPopup.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.google.android.material.textfield.MaterialAutoCompleteTextView.1
            ...
            public void onItemClick(AdapterView<?> parent, View selectedView, int position, long id) {
                Object selectedItem;
                if (position < 0) {
                    selectedItem = MaterialAutoCompleteTextView.this.modalListPopup.getSelectedItem();
                } else {
                    selectedItem = MaterialAutoCompleteTextView.this.getAdapter().getItem(position);
                }
