...
public class ShapePath {
    ...
    public void addArc(float left, float top, float right, float bottom, float startAngle, float sweepAngle) {
        ...
        float f = drawShadowInsideBounds ? (ANGLE_LEFT + startAngle) % 360.0f : startAngle;
        if (drawShadowInsideBounds) {
            endAngle = (ANGLE_LEFT + endAngle) % 360.0f;
        }
        addShadowCompatOperation(arcShadowOperation, f, endAngle);
