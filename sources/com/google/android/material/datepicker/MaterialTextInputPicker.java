...
public final class MaterialTextInputPicker<S> extends PickerFragment<S> {
    ...
    @NonNull
    public static <T> MaterialTextInputPicker<T> newInstance(DateSelector<T> dateSelector, @StyleRes int themeResId, @NonNull CalendarConstraints calendarConstraints) {
