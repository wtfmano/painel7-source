...
public class RequestNetworkController {
    ...
    private OkHttpClient getClient() {
        if (this.client == null) {
            ...
            try {
                TrustManager[] trustManagerArr = {new X509TrustManager() { // from class: com.br.painel.RequestNetworkController.1
                ...
                builder.hostnameVerifier(new HostnameVerifier() { // from class: com.br.painel.RequestNetworkController.2
    ...
    public void execute(final RequestNetwork requestNetwork, String str, String str2, final String str3, final RequestNetwork.RequestListener requestListener) {
        ...
        try {
            ...
            getClient().newCall(builder.build()).enqueue(new Callback() { // from class: com.br.painel.RequestNetworkController.3
                ...
                public void onFailure(Call call, final IOException iOException) {
                    ...
                    activity.runOnUiThread(new Runnable() { // from class: com.br.painel.RequestNetworkController.3.1
                ...
                public void onResponse(Call call, final Response response) throws IOException {
                    ...
                    final RequestNetwork.RequestListener requestListener2 = requestListener;
                    final String str4 = str3;
                    activity.runOnUiThread(new Runnable() { // from class: com.br.painel.RequestNetworkController.3.2
                        @Override // java.lang.Runnable
                        public void run() {
